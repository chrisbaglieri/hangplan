...
describe Facebook do
  ...
  it "should load the connection details" do
    ...
    Facebook.config[:scope].should == "user_photos,user_location,user_events,user_location,email,user_checkins,create_event,rsvp_event,offline_access,publish_checkins,publish_stream"
